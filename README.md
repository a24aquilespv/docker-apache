...
- Como indicarias que  porto de escoita é o 8080 para o enderezo 127.0.0.1 e 80 para o resto?
Fichero: /etc/apache2/ports.conf
Directiva: Listen
    Listen 127.0.0.1:80
    Listen *:8888
- Como se podería facer para ter un host virtual que so sexa accesible no porto 9000 na interface de rede de lazo pechado?
